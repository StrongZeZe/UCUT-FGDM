...
ariginal_file = os.path.join(position3, f"group_utility_loss_1.pkl")
...
ax.set_ylabel('UL-loss', fontsize=base_fontsize, labelpad=6)
...
if len(list_data) < 30:  # 如果数据点较少，可以标记所有点
    ...
    ax.annotate(f'Max: {list_data[max_idx]:.3f}',
                ...
                xytext=(25, 20), ha='center', fontsize=base_fontsize,
    ...
    ax.annotate(f'Start: {list_data[0]:.3f}',
                ...
                textcoords="offset points",
                xytext=(10, 0), ha='left', fontsize=base_fontsize)
...
# 保存图像 - 使用高DPI以确保印刷质量
save_path = r"E:\newManucript\manuscript2\image\12yue\Fig7.png"
...
save_path_double = r"E:\newManucript\manuscript2\image\12yue\Fig7_double.png"
